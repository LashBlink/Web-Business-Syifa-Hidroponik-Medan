                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="#">Tentang Syifa Hidroponik</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="btn-group">
                            <a herf="#">
                                <button type="button" class="btn banner">Lihat</button>
                            </a>
                        </div>
                    </div>
                    <div class="col">
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <span class="align-middle"> <iframe width="560" height="315" src="https://www.youtube.com/embed/pMk24G6b540" allowfullscreen></iframe>
                    </div>
