        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="/admin/tampilproduk" class="nav-link px-0"> <span class="d-none d-sm-inline">Data Produk</span></a>
                    </li>
                    <li>
                        <a href="/admin/tambahproduk" class="nav-link px-0"> <span class="d-none d-sm-inline">Tambah Produk</span></a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="/admin/tampilpost" class="nav-link px-0"> <span class="d-none d-sm-inline">Data Post</span></a>
                    </li>
                    <li>
                        <a href="/admin/tambahpost" class="nav-link px-0"> <span class="d-none d-sm-inline">Tambah Post</span></a>
                    </li>
                </ul>
            </li>
        </ul>
